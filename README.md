...
6. `data/planning/p03b_orientation_causal_protocol_v1.json` / `docs/P03B_ORIENTATION_CAUSAL_PROTOCOL_V1.md` — frozen orientation mechanism-to-fitness design; device/sample-size/site gates remain closed.
7. `data/intake/chapter3_individual_intake_v1.csv` — currently empty same-individual intake ledger.
